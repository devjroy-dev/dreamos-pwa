"use client";
// app/w/events/page.tsx — EVENTS, INSIDE THE SHELL. R-38.1 + R-38.11.
//
// The calendar's list face. Distinct from the `calendar` room, which crosses at §4-2 and
// is a different surface with a different door.
//
// ── WHAT CROSSED ────────────────────────────────────────────────────────────
// THE STRUCTURE. This route is a child of app/w/layout.tsx, so tapping the Events tile
...
import EventsSlice from '@/app/vendor/list/[slice]/events';

export default function ShellEventsPage() {
  ...
  return (
    <WorklistShell title={COPY.eventsTitle}>
      <RoomBody><EventsSlice vendorId={session.id} /></RoomBody>
    </WorklistShell>
  );
}
