'use client';
// app/vendor/tds/page.tsx — THE SURVIVING FALLBACK ROUTE.
//
// ── §4-4 · TDS CROSSED, AND THIS FILE IS WHAT STAYED BEHIND ──
// The room the vendor reaches from the tile is `/w/tds` now. This route is not deleted and
// must not be: R-38.11's "nothing deletes" holds until Phase 7 retires
