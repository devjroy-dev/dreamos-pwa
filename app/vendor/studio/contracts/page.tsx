    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#F8F7F5', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ padding: '24px 20px 0' }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, fontSize: 28, color: '#111111', margin: '0 0 4px' }}>Contracts</h1>
          <p style={{ fontFamily: "'Jost', sans-serif", fontWeight: 200, fontSize: 11, color: '#888580', margin: 0 }}>Agreements & docs</p>
        </div>
        {/* Coming soon */}
