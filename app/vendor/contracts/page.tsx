'use client';
// app/vendor/contracts/page.tsx — THE SURVIVING FALLBACK ROUTE.
//
// ── §4-4 · CONTRACTS CROSSED, AND THIS FILE IS WHAT STAYED BEHIND ──
// The room the vendor reaches from the tile is `/w/contracts` now. This route is not deleted and
