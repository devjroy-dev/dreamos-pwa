  ...
  return (
    <CanvasShell eyebrow="Moments" backTo="/frost/canvas/sanctuary">
      <div style={{ padding: `${SP.xl}px ${SP.xxl}px ${SP.huge}px`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: FF.body, fontSize: 15, color: t.soft, lineHeight: 1.8, maxWidth: 300, marginBottom: SP.xl }}>
        ...
        <div style={{ fontFamily: FF.body, fontSize: 14, color: t.soft, lineHeight: 1.7, maxWidth: 280, marginBottom: SP.huge }}>
          A month after the wedding, you'll scroll through and remember not the chaos but the warmth.
        </div>

        <div style={{ fontFamily: FF.label, fontSize: 10, letterSpacing: '0.25em', textTransform: 'uppercase', color: t.brassMuted }}>
