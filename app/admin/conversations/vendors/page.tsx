...
function MessageBubble({ msg }: { msg: Message }) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: isVendor ? 'flex-end' : 'flex-start', marginBottom: 8 }}>
      <div style={{ maxWidth: '80%', background: isVendor ? T.gold : 'var(--atelier-card-bg)', border: isVendor ? 'none' : `0.5px solid ${T.border}`, borderRadius: isVendor ? '16px 4px 16px 16px' : '4px 16px 16px 16px', padding: '10px 14px' }}>
