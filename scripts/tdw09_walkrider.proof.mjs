...
// AMENDED BY LABEL · CE-45 FE-2 TYPE_1b: the sub-line and the eyebrow collapsed into the room's ONE line
// (the founder's rows 4-8); it keeps the body voice at the same rung, so the cell reads {line}.
ok('§3.1 the sub-line wears the body voice at its rung', /font: T\.t4,[^}]*\}\}>\{line\}/.test(MAST));
