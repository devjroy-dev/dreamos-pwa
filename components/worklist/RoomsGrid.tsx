...
const GRID_CSS = `
.wl-row{display:flex;align-items:center;gap:11px;width:100%;min-height:64px;padding:14px 18px;background:var(--atelier-section-bg);border:none;border-top:.5px solid var(--atelier-card-border);cursor:pointer;text-align:left}
.wl-row + .wl-row{border-bottom:.5px solid var(--atelier-card-border)}
...
.wl-linkcard{margin:14px 16px 10px;background:var(--atelier-card-bg);border:.5px solid var(--atelier-card-border);border-radius:3px;padding:17px}
